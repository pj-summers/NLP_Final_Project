...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Guitar Teacher RAG Assistant",
    page_icon="📖",
    layout="wide"
)
...
with st.sidebar:
    ...
    st.markdown("""
    ### About
    This RAG assistant answers questions about the process of learning guitar as a beginner using:
    - Guitar learning video transcripts
    - Research articles about the best methods
...
# Main App Header
# -----------------------------------------------------------------------------
st.title("📖 Guitar Teacher RAG Assistant")
st.markdown("Ask questions about the basics of learning guitar and get AI-powered answers based on curated content.")
